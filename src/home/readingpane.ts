...
import { DropDownList, SelectEventArgs as DropDownSelectEventArgs, FilteringEventArgs, MultiSelect } from '@syncfusion/ej2-dropdowns';
import { Accordion, ClickEventArgs, Toolbar } from '@syncfusion/ej2-navigations';
...
function clearMailForm(): void {
    if (autoCCList.value) {
        autoCCList.value = [] as unknown as [string];
    }
    if (autoToList.value) {
        autoToList.value = [] as unknown as [string];
    }
