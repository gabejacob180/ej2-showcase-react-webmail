 ...
 * datasource
 */
export const userName: string = "Andrew Fuller";
export const userMail: string = "andrewfuller@syncfusion.com";

export const folderData: { [key: string]: unknown }[] =
[{
    "ID": 1,
    "PID": null,
    "Name": "Favorites",
...
export const messageDataSourceNew: { [key: string]: unknown }[] = [
  {
    "ContactID": "SF10153",
    "text": "Oleg Oneill",
...
export function getContacts(): { [key: string]: unknown }[] {
    const contacts1: { [key: string]: unknown }[] = [];
...
function addContacts(messageData: { [key: string]: unknown }, mailId: string, text: string, contacts: { [key: string]: unknown }[]): { [key: string]: unknown }[] {
    let fieldId: string = 'MailId';
    // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
    const contacts1: { [key: string]: unknown }[] = [];
    let contactData: { [key: string]: unknown } = {};
    if (messageData[mailId]) {
        if (messageData[mailId] instanceof Array) {
            const mailIdList: string[] = messageData[mailId] as string[];
            const contactsList: string[] = messageData[text] as string[];
...
function istextExist(contacts: { [key: string]: unknown }[], text: string): boolean {
